...
unset($__errorArgs, $__bag); ?>" placeholder="Required" aria-label="Username" aria-describedby="basic-addon1">
...
unset($__errorArgs, $__bag); ?>" placeholder="Required" aria-label="Password" aria-describedby="basic-addon1">
                                        ...
                                        <div class="col-12 mt-3">
                                            <div class="row">
                                                ...
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        <div class="text-center">                                                            
                                                            <a href="<?php echo e(route('frontend.user.create')); ?>" class="btn btn-transparent">
                                                                <u>Create Account</u>
                                                            </a>
                                                        </div>
                                                    </div>
...
</html><?php /**PATH /srv/www/htdocs/laravel10/cavely-stable/resources/views/backend/v_login/login.blade.php ENDPATH**/ ?>