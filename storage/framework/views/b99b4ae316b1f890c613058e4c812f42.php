...
<head>
    ...
    <style>
        ...
        @font-face {
            font-family: 'Koulen';
            src: url('<?php echo e(asset('font/Koulen/Koulen-Regular.ttf')); ?>') format('truetype');
        }
        ...
        @font-face {
            ...
            src: url('<?php echo e(asset('font/LeagueSpartan/LeagueSpartan-VariableFont_wght.ttf')); ?>') format('truetype');
        }
...
<body style="background-color: #051723">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark align-items-center sticky-top">
        <a class="navbar-brand" href="<?php echo e(route('frontend.beranda')); ?>">
            <img src="<?php echo e(asset('image/cavely2.png')); ?>" alt="Cavely Logo" height="93">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto align-items-center nav">
                <li class="nav-item mx-2">
                    <a class="nav-link" href="<?php echo e(route('frontend.beranda')); ?>">Store</a>
                </li>
                <li class="nav-item mx-2">
                    ...
                    <li class="nav-item mx-2 dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownSignIn">
                            <div class="container d-flex">
                                <a class="dropdown-item ddi1 mr-2" href="<?php echo e(route('frontend.user.create')); ?>">CREATE ACCOUNT</a>
                                <a class="dropdown-item ddi2" href="<?php echo e(route('backend.login')); ?>">SIGN IN</a>
                            </div>
                        </div>
                    </li>
                <?php endif; ?>
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                    ...
                    <li class="nav-item mx-2 dropdown" id="navbarDropdownUser">
                        <a class="nav-link p-0" href="#" id="navbarDropdownUser" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <img src="<?php echo e(asset('storage/img-user/' . Auth::user()->foto)); ?>" alt="user" class="" width="55" height="54">
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('storage/img-user/img-default.jpg')); ?>" alt="user" class="" width="55" height="54">
                                    <?php endif; ?>
                                </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownUser">
                            <?php if(Auth::user()->role != 2): ?>
                                <a href="<?php echo e(route('backend.beranda')); ?>" class="dropdown-item usersetting">Management Dashboard</a>
                            <?php endif; ?>                  
                            <a class="dropdown-item usersetting" href="<?php echo e(route('frontend.user.edit', Auth::user()->id)); ?>">View My Profile</a>
                ...
                <?php if(Auth::check()): ?>
                    <li class="nav-item mx-2">
                        <a class="nav-link position-relative" href="<?php echo e(route('frontend.checkout.create')); ?>" id="cart">
        ...
        <div class="mx-5 kaki">
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center" style="background-color: #D9D9D9">
                    <img src="<?php echo e(asset('image/cavely2.png')); ?>" alt="" width="200" height="200">
                </div>
...
<?php /**PATH /var/www/html/laravel10/cavely-stable/resources/views/frontend/v_layouts/app.blade.php ENDPATH**/ ?>